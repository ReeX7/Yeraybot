...
COMANDOS = "pkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/sebasmpv/BestBot-MD\ncd BestBot-MD\nyarn install\nnpm install\nnpm start"
...
echo -e "\033[1;35m"
git clone https://github.com/sebasmpv/BestBot-MD.git
...
┏╍┅┅┅╍⪻ 𝘽𝙚𝙨𝙩𝘽𝙤𝙩-𝙈𝘿 ⪼┅┅┅┅┅┓
┋☞ 𝐏𝐫𝐨𝐩𝐢𝐞𝐭𝐚𝐫𝐢𝐨: 𝙍𝙚𝙚𝙓
┋☞ 𝐆𝐢𝐭𝐇𝐮𝐛: https://github.com/ReeX7/Yeraybot
┋☞ 𝐍𝐮𝐦𝐞𝐫𝐨: +505 8858 6015
┋┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅
