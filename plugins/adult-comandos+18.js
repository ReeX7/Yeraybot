...
const handler = async (m, {command, conn}) => {
  if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*⚠️ 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑫𝑬𝑺𝑨𝑪𝑻𝑰𝑽𝑨𝑫𝑶, 𝑺𝑰 𝑬𝑹𝑬𝑺 𝑨𝑫𝑴𝑰𝑵 𝑼𝑺𝑨𝑬𝑲 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 !enable modohorny*';
...
if (command == 'tetas') {
    const resError = (await axios.get(`https://raw.githubusercontent.com/sebasmpv/BestBot-MD/master/src/JSON/tetas.json`)).data
;
